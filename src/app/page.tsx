...
export default async function Home() {
  ...
  return   (
      <Article id={"home"} className={`flex flex-col justify-center items-center mt-[12%]`}>
          ...
          {/*/!* Section Two *!/*/}
          {/*<section id="experience" className={`flex flex-col text-black bg-stone-100 border`}>*/}
          {/*    <h2 className={`border-b-2 border-black my-2`}>My Experience</h2>*/}
          ...
          {/*</section>*/}
          {/*/!*Section three*!/*/}
          {/*<section id="technologies" className={`flex flex-col text-black bg-stone-100`}>*/}
          ...
          {/*                            <li key={j}*/}
          {/*                                className={`flex flex-col justify-center items-center rounded-lg shadow-lg p-5 m-2.5 border border-opacity-50 border-black`}>*/}
          {/*                                <div className={`min-w-16 w-10 h-auto`} aria-hidden={true}>*/}
          {/*                                  <Icon type={highlight?.icon ?? ''} altText={''}/>*/}
          {/*                                </div>*/}
          {/*                                <p>{highlight.name}</p>*/}
          {/*                            </li>*/}
          {/*                        )}*/}
          ...
          {/*</section>*/}
          {/*/!* Section four *!/*/}
          {/*<section id="projects" className={`flex flex-col bg-stone-100`}>*/}
          {/*    <h2 className={`border-b-2 border-neutral-600 text- my-2`}>Projects</h2>*/}
          {/*    <ol className={`flex flex-col xl:flex-row`}>*/}
          {/*        {*/}
          {/*            projects.map((project: Project, i: number) =>*/}
          {/*                <li key={i} className={`flex flex-col m-2 p-5 rounded-lg shadow-lg min-w-[225px] border border-opacity-50 border-black`}>*/}
          ...
          {/*                    <span*/}
          {/*                        className={` bg-gray-300 text-center border rounded-lg shadow-lg text-black font-bold my-5 p-2 border-black hover:border-sky-600 hover:text-sky-600 hover:border-2 max-w-[200px] hover:shadow-xl`}>*/}
